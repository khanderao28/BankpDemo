...
public class TC01_DepositTest extends Basic {
	...
	public void init() throws InterruptedException {
		...
		l.login();
		l.Deposit();
		//d.findElement(By.xpath("//a[contains(text(),'Deposit')]")).click();
	...
	public void depositAccount() throws IOException, InterruptedException {
		...
		String str1=ammount();
		System.out.println("Deposited account is- "+str1);
		...
		String str3=d.findElement(By.xpath("//*[@id=\"deposit\"]/tbody/tr[23]/td[2]")).getText();
		Newaccount.AddDepositORWidrow(str, str3);
		//Newaccount.writeData1();
		d.findElement(By.xpath("//*[@id=\"deposit\"]/tbody/tr[24]/td/a")).click();
